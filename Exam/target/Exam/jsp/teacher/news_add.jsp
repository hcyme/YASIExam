			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/teacher/index.jsp">首页</a><span
						...
						href="jsp/teacher/news_list.jsp">消息中心</a><span class="crumb-step">&gt;</span><span>发布消息</span>
				</div>
			</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><input class="common-text required" id="startTime"
										name="startTime" size="50" value="" type="date"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>有效结束时间：</th>
									<td><input class="common-text required" id="endTime"
										name="endTime" size="50" value="" type="date"></td>
								</tr>
								<tr>
									<th></th>
