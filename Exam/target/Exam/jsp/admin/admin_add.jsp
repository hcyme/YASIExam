				...
				<ul class="sidebar-list">
					<li>
						<ul class="sub-menu">
							...
							<li class="on"><a
								href="ManageAdminServlet?flag=find&pageNum=1"><i
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						...
						href="jsp/admin/news_list.jsp">管理员管理</a><span class="crumb-step">&gt;</span><span>添加管理员</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="ManageAdminServlet?flag=add&pageNum=1" method="post"
							...
							<tbody>
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="m_id" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>密码：</th>
									<td><input class="common-text required" id="newpassword"
										name="m_pass" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>确认密码：</th>
									<td><input class="common-text required" id="people"
										name="pass" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>姓名：</th>
									<td><input class="common-text required" id="people"
										name="m_name" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th></th>
