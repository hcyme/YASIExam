<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.hcy.entity.Question"%>
	...
	<div class="container clearfix">
				...
				<form name="myform" id="myform" method="post">
					<div class="result-title">
						<div class="result-list">
							<a href="servlet/ManageQuestion.do?flag=toAdd"><i
								class="icon-font"></i>添加试题</a>
							<a id="export"
							   href="<%=request.getContextPath()%>/ExportExcelServlet"><i class="icon-font"></i>导出试题</a>
								<%--<a id="batchDel"
					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<c:if test="${! empty pager }">
								<c:if
									...
									<c:forEach items="${pager.getDateList() }" var="question"
										varStatus="v">
						...
						<div class="list-page">
							&nbsp;&nbsp;<input class="btn btn-primary btn3 mr10" value="首页"
								type="button" onclick="homeClick()"><input
								class="btn btn-primary btn3 mr10" value="上一页" type="button"
								onclick="preiousClick()">
							<%=pageSize%>条
							<%=currentPage%>/<%=totalPage%>页&nbsp;&nbsp;<input
								class="btn btn-primary btn3 mr10" value="下一页" type="button"
								onclick="nextClick()"><input
								class="btn btn-primary btn3 mr10" value="尾页" type="button"
								onclick="lastClick()">
		...
		<%=currentPage%>
			;
				...
				hr = "servlet/ManageQuestion.do?flag=find&type=0&pager="
						+ currentPage + "&manager=admin";
