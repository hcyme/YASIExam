	...
	$(function() {
		...
		function skipPage(page) {
			with (document.getElementById("page")) {
				method = "post";
				action = "servlet/ManageQuestion.do?flag=find&manager=admin&pager="
						+ page;
				submit();
			}
		}
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						class="crumb-step">&gt;</span><span class="crumb-name">考试管理</span>
				</div>
			</div>
							...
							<c:if test="${! empty pager }">
								<c:if
									...
									<c:forEach var="paperBean" items="${pager.getDateList() }"
										varStatus="v">
										<tr>
											<td class="tc" width="5%"><input class="allChoose"
												name="" type="checkbox"></td>
											<td>${v.index+1}</td>
											<td><c:forEach items="${classesList}" var="classes">
											...
											<td width="10%"><a class="link-update"
