				...
				<ul class="sidebar-list">
					<li>
						<ul class="sub-menu">
							...
							<li class="on"><a
								href="ManageTeacherServlet?flag=find&pageNum=1"><i
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						...
						href="jsp/admin/news_list.jsp">教师管理</a><span class="crumb-step">&gt;</span><span>修改信息</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="ManageTeacherServlet?flag=update&pageNum=1"
							...
							<tbody>
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="t_id" size="50"
										value="<%=request.getParameter("t_id")%>" type="text"
								...
								<tr>
									...
									<td><input class="common-text required" id="people"
										name="t_name" size="50"
										value="<%=request.getParameter("t_name")%>" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>新密码：</th>
									<td><input class="common-text required" id="people"
										name="t_pass" size="50"
										value="<%=request.getParameter("t_pass")%>" type="text"></td>
								</tr>
								...
								<tr>
									...
									<td><input class="common-text required" id="people"
										name="t_Job" size="50"
										value="<%=request.getParameter("t_Job")%>" type="text"></td>
								</tr>
								<tr>
									<th></th>
