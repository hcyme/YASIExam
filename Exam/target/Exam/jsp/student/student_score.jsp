...
<body>
	...
	<div class="clear list_top ovhi psRe">
		...
		<a class="disin psAb menuname"
			href="servlet/StudentServlet.do?operation=toMyTest">我的成绩&nbsp;&nbsp;My
			Score</a>
	</div>
...
.content a {
	text-decoration: underline;
					...
					<table border="1" cellpadding="0" cellspacing="0" id="changecolor"
						style="width: 100%;">
						...
						<tbody>
							...
							<c:forEach var="sco" items="${scores}" varStatus="status">
								<tr>
									<td align="left"><a href="#">${sco.p_name}</a></td>
									<td>${sco.sc_date}</td>
					...
					<div class="page">
						第一页 | &lt;&lt;上一页 1 <a href="#">2</a> <a href="#">3</a> <a
							href="#">4</a> <a href="#">5</a> <a href="#">6</a> <a href="#">7</a>
						<a href="#">8</a> <a href="#">下一页&gt;&gt;</a> | <a href="#">最后一页</a>
					</div>
				</div>
				<div class="bk20"></div>
			</div>
