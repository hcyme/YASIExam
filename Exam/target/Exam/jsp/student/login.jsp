		...
		<div class="header">
			<div class="switch" id="switch">
				<a class="switch_btn_focus" id="switch_qlogin"
					href="javascript:void(0);">学生登录</a> <a class="switch_btn"
					id="switch_login" href="javascript:void(0);">老师登录</a>
		...
		<div class="web_qr_login" id="web_qr_login" style="display: block;">
			<div class="web_login">
				<form name="student_login"
					action="StudentAndTeacherAdminLoginServlet?status=student"
		...
		<div class="qlogin" id="qlogin" style="display: none;">
			<div class="web_login">
				<form name="teacher_login" id="regUser" accept-charset="utf-8"
					action="StudentAndTeacherAdminLoginServlet?status=teacher"
					method="post" onsubmit="return login_teacherID_username()">
					<ul class="reg_form" id="reg-ul">
						<div id="teacherCue" class="cue">请输入职工号和密码进行登录</div>
						<li><label for="user" class="input-tips2">职工号：</label>
							<div class="inputOuter2">
						...
						<li><label for="yanzheng" class="input-tips2">验证码：</label>
							<div class="inputOuter2">
								<input type="text" id="yanzheng" name="code" maxlength="16"
									class="inputstyle2" style="width: 135px; float: left;" /> <img
									id="image2" src="IdentifyingCodeServlet" height="38px"
									onclick="change2()" />
							</div></li>
						<li style="height: 30px;"><label for="yanzheng"
							class="input-tips2"></label> <label><input
