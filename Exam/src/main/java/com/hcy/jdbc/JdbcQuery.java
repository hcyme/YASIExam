...
public interface JdbcQuery {
	...
	public abstract void setParameter(String parameterName, Object value, boolean isDbFunction);
	...
	public abstract <T> List<T> getResultList(String parameterName, Class<T> classType);
