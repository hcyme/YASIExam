...
//			response.setHeader("ReFresh", "2;url="+request.getContextPath()+"/jsp/teacher/test_list.jsp");
		...
		if (operation.equals("update")) {
			...
			// request.getRequestDispatcher("/PaperManageServlet?operation=update").forward(request,
			// response);
		}
	...
	public void newPaper(Paper p, String course, String papername, String[] q_id, Float score, String startTime,
			String endTime, String createUser, String classes) throws ParseException {
