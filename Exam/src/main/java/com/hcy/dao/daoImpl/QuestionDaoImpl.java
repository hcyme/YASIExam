...
public class QuestionDaoImpl {
	...
	/*
	 * 方法名:getQuestion 参数: question Question对象 决定选择条件 page 整形变量
	 * 参数大于0表示查询的第几页，参数小于0表示查询全部结果 number 整形变量 当页数大于0时表示返回结果数量 返回值:
	 * LinkedList<Question>类型的序列
	 */
	...
	/*
	 * 方法名:getQuestion 参数: qList String 查找qList(题目编号串)中题目 page 整形变量
	 * 参数大于0表示查询的第几页，参数小于0表示查询全部结果 number 整形变量 当页数大于0时表示返回结果数量 返回值:
	 * LinkedList<Question>类型的序列
	 */
	...
	/*
	 * 方法名:deleteQuestion 参数: question Question对象 决定选择条件 返回值: String类型字符串,表示查询结果
	 */
	...
	/*
	 * 方法名:updateQuestion 更新符合条件的数据 参数: question Question对象 决定选择条件 返回值:
	 * String类型字符串,表示查询结果
	 */
	...
	/*
	 * 方法名:addQusetion 更新符合条件的数据 参数: question Question对象 添加对象 返回值:
	 * String类型字符串,表示查询结果
	 */
