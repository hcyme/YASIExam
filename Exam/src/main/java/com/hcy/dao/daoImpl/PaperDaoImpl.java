...
public class PaperDaoImpl {
	...
	/*
	 * 方法名:getPapers 参数: paper Paper对象 决定选择条件 page 整形变量 参数大于0表示查询的第几页，参数小于0表示查询全部结果
	 * number 整形变量 当页数大于0时表示返回结果数量 返回值: LinkedList<Paper>类型的序列
	 */
	...
	/*
	 * 方法名:deletePaper 参数: paper Paper对象 决定选择条件 返回值: String类型字符串,表示查询结果
	 */
	...
	/*
	 * 方法名:updatePaper 更新符合条件的数据 参数: paper Paper对象 决定选择条件 返回值: String类型字符串,表示查询结果
	 */
	...
	/*
	 * 方法名:addPaper 更新符合条件的数据 参数: paper Paper对象 添加对象 返回值: String类型字符串,表示查询结果
	 */
