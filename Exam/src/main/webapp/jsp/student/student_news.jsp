...
<%@page
	import="com.hcy.dao.daoImpl.*, com.hcy.entity.*,java.util.*,java.util.Date,java.text.*"%>
...
<body>
	...
	<div class="clear list_top ovhi psRe">
		...
		<a class="disin psAb menuname" href="#">信息公告&nbsp;&nbsp;News &
			Announcement</a>
	</div>
		...
		<div class="list_left lf">
			...
			<ul class="wrap_sub">
				...
				<li class="on"><a class="subnav_a"
					href="jsp/student/student_news.jsp">信息公告</a></li>
		...
		<div class="list rt list_main">
			...
			<ul class="ovhi">
				...
				<c:forEach var="ann" items="${anns}" varStatus="status">
					<li><a
						href="jsp/student/student_news_text.jsp?search_id=${ ann.a_id}"
						title="${ann.a_title } "> <font class="cor3 rt padl10">发布时间:${ann.a_startTime }</font>${ann.a_title }</a>
					</li>
				</c:forEach>
