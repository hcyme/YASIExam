		...
		<div class="topbar-inner clearfix">
			<div class="topbar-logo-wrap clearfix">
				<ul class="navbar-list clearfix">
					<li><a class="on" href="jsp/admin/index.jsp">亚斯在线考试系统</a>
					</li>
				</ul>
			</div>
		...
		<div class="sidebar-wrap">
			...
			<div class="sidebar-content">
				<ul class="sidebar-list">
					<li>
						<ul class="sub-menu">
							<li class="on"><a href="jsp/admin/index.jsp"><i
									class="icon-font">&#xe012;</i>基本信息</a></li>
		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font">&#xe06b;</i><span>欢迎使用亚斯在线考试系统后台管理</span>
				</div>
			</div>
			...
			<div class="result-wrap">
				...
				<div class="result-content">
					<ul class="sys-info-list">
						<li><label class="res-lab">用户名</label><span class="res-info">${adm_name }</span>
						</li>
						<li><label class="res-lab">系统时间</label><span class="res-info"><%=now%></span>
						</li>
						<li><label class="res-lab">上次登录时间</label><span
							class="res-info">${lastTime }</span></li>
						<li><label class="res-lab"></label> <a
							href="jsp/admin/modify_password.jsp"><input
