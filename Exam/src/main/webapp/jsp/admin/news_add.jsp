			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						...
						href="jsp/admin/news_list.jsp">消息中心</a><span class="crumb-step">&gt;</span><span>发布消息</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="DoAddAnnoucementServlet" method="post" id="myform"
						name="myform">
							...
							<tbody>
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="a_title" size="50" value="" type="text"></td>
								</tr>
								<tr>
