	...
	<div class="admin_login_wrap">
		...
		<div class="login">
			...
			<div class="web_login" style="margin-top: 20px">
				<form action="StudentAndTeacherAdminLoginServlet?status=admin"
					method="post">
					<input type="hidden" id="error" value="${error}" />
					<ul class="reg_form">
						<li><label for="user" class="input-tips2">用户名：</label> <input
							type="text" name="adminID" value="" id="adminID" size="35"
							class="inputstyle2" /></li>
						<li><label for="pwd" class="input-tips2">密码：</label> <input
							type="password" name="adminPassword" value="" id="adminPassword"
							size="35" class="inputstyle2" /></li>
						<li><label for="yanzheng" class="input-tips2">验证码：</label>
							<div class="inputOuter2">
								<input type="text" id="yanzheng" name="code" maxlength="16"
									class="inputstyle2" style="width: 135px; float: left;" /> <img
									id="image1" src="IdentifyingCodeServlet" height="38px"
									onclick="change()" />
							</div></li>
