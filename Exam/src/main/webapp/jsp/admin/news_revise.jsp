				...
				<ul class="sidebar-list">
					<li>
						<ul class="sub-menu">
							...
							<li class="on"><a href="jsp/admin/news_list.jsp"><i
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/admin/index.jsp">首页</a><span
						...
						href="jsp/admin/news_list.jsp">消息中心</a><span class="crumb-step">&gt;</span><span>修改消息</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="DoUpdateAnnouncementServlet" method="post"
							...
							<tbody>
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="a_title" size="50" value="${ann.a_title}" type="text">
									</td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>内容：</th>
									<td><textarea name="a_content" class="common-textarea"
											id="a_content" cols="30" style="width: 98%;" rows="10">${ann.a_content}</textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<td><input class="common-text required" id="people"
										name="a_author" size="50" value="管理员" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>修改时间：</th>
									<td><input class="common-text required disabled" id="time"
										name="time" size="50" value="" type="text" disabled="disabled">
									</td>
								</tr>
								<tr>
									<th></th>
									<td><input type="hidden" name="a_id" value="${ann.a_id}">
