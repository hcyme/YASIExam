		...
		<div class="topbar-inner clearfix">
			<div class="topbar-logo-wrap clearfix">
				<ul class="navbar-list clearfix">
					<li><a href="index.html">亚斯在线考试系统</a></li>
				</ul>
			</div>
			<div class="top-info-wrap">
				<ul class="top-info-list clearfix">
					<li><a href="jsp/admin/index.jsp">你好！${adm_name }</a></li>
					<li><a href="modify_password.html">修改密码</a></li>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="index.html">首页</a><span
						class="crumb-step">&gt;</span><span class="crumb-name">及格率</span>
				</div>
			</div>
			<div class="result-wrap">
				...
				<div class="result-content">
					<ul class="sys-info-list">
						<li><label class="res-lab">考试编号</label><span class="res-info">0000000001</span>
						</li>
						<li><label class="res-lab">名称</label><span class="res-info">c语言</span>
						</li>
						<li><label class="res-lab">所属课程</label><span class="res-info">计算机</span>
						</li>
						<li><label class="res-lab">考试班级</label><span class="res-info">计算机1班</span>
						</li>
						<li><label class="res-lab">及格率</label><span class="res-info">100%</span>
						</li>
						<li><label class="res-lab"></label> <input class="btn btn6"
							onClick="history.go(-1)" value="返回" type="button"></li>
					</ul>
				</div>
			</div>
		</div>
