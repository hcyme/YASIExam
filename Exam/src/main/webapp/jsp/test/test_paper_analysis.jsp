			...
			<div class="psRe head">
				<h2 class="logo">
					<a class="disin" href="servlet/StudentServlet.do?operation=toIndex"><img
						src="images/index_logo.png" alt="SgExam在线考试系统" /></a>
				</h2>
				<div class="menuname text_font">C语言</div>
		...
		<div class="list_left lf">
			...
			<ul class="wrap_sub">
				<li class="on"><a class="subnav_a"
					href="student_exam_list.html">单选题</a></li>
				<li><a class="subnav_a" href="student_score.html">多选题</a></li>
				<li><a class="subnav_a" href="student_news.html">判断题</a></li>
				<li><a class="subnav_a" href="student_personal.html">简答题</a></li>
			</ul>
		</div>
