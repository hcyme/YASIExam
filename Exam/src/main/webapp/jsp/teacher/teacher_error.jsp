		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/teacher/index.jsp">首页</a><span
						...
						href="jsp/teacher/subject_list.jsp">错误提示</a><span
			...
			<div class="result-wrap">
				<div class="result-content">
					<div
						style="width: 600px; margin: 0 auto; margin-top: 50px; box-shadow: 1px 1px 5px #666666;"
						...
						<div class="panel-body">
							<div class="text-center text-danger">
								<span class="glyphicon glyphicon-remove-sign msg-icon"></span> <span
									class="msg-text">${error }</span><br /> <a
									href="javascript:void(0);" onclick="window.history.go(-1);"
									class="btn btn-danger"><i
									class="glyphicon glyphicon-share-alt"></i> 返 回 </a>
							</div>
						</div>
					</div>
				</div>
