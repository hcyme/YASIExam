				...
				$("#classes")
						.ready(
								function() {
									$
											.get(
													"PaperManageServlet?operation=findAllClasses",
													function(data) {
														var classesList = JSON
																.parse(data);
														for (var i = 0; i < classesList.length; i++) {
															var option = $("<option value="+classesList[i].cls_id+">"
																	+ classesList[i].cls_name
																	+ "</option>");
															$("#classes")
																	.append(
																			option);
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/teacher/index.jsp">首页</a><span
						...
						href="jsp/teacher/test_list.jsp">考试管理</a><span class="crumb-step">&gt;</span><span>添加考试</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="PaperManageServlet?operation=add" method="post"
						id="myform" name="myform">
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									<th>考试班级</th>
									<td><select name="classes" id="classes" class="required">
											<option value="0">请选择班级</option>
									</select></td>
								</tr>
								<tr>
									<th width="120"><i class="require-red">*</i>所属课程：</th>
									<td><select name="course" id="ctype" class="required">
								...
								<tr>
									...
									<td><input class="common-text required" id="title"
										name="papername" size="50" value="" type="text"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input class="common-text required" id="score"
										name="score" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>考试日期：</th>
									<td><input class="common-text required" id="title"
										name="p_date" size="50" value="" type="date"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>考试开始时间：</th>
									<td><input class="common-text required" id="title"
										name="startTime" size="50" value="" type="time"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>考试结束时间：</th>
									<td><input class="common-text required" id="title"
										name="endTime" size="50" value="" type="time"></td>
								</tr>
								<tr>
									<th></th>
