		...
		<div class="topbar-inner clearfix">
			<div class="topbar-logo-wrap clearfix">
				<ul class="navbar-list clearfix">
					<li><a class="on" href="jsp/teacher/index.jsp">亚斯在线考试系统</a>
					</li>
				</ul>
			</div>
		...
		<div class="sidebar-wrap">
			...
			<div class="sidebar-content">
				<ul class="sidebar-list">
					<li>
						<ul class="sub-menu">
							<li class="on"><a href="jsp/teacher/index.jsp"><i
									class="icon-font">&#xe012;</i>个人中心</a></li>
		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font">&#xe06b;</i><span>欢迎使用亚斯在线考试系统教师端</span>
				</div>
			</div>
			...
			<div class="result-wrap">
				...
				<div class="result-content">
					<ul class="sys-info-list">
						<li><label class="res-lab">职工号</label><span class="res-info">${tea_id }</span>
						</li>
						<li><label class="res-lab">姓名</label><span class="res-info">${tea_name }</span>
						</li>
						<li><label class="res-lab">院系</label><span class="res-info">科学院</span>
						</li>
						<li><label class="res-lab">职称</label><span class="res-info">院长</span>
						</li>
						<li><label class="res-lab"></label> <a
							href="jsp/teacher/modify_password.jsp"><input
								class="btn btn-primary btn6 mr10" value="更改密码" type="button"></a>
						</li>
					</ul>
				</div>
			</div>
