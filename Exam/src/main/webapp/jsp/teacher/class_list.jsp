	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
			...
			<div class="result-wrap">
				<form
					action="Class_List_BrowseServlet?updateclassform=updateClassForm"
						...
						<table class="result-tab" width="100%">
							...
							<c:forEach var="bean" items="${list}">
								...
								<tr>
									...
									<td width="30%"><a class="link-update"
										href="jsp/teacher/class_student_list.jsp?classid=${bean.cls_id}">查看班级</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
