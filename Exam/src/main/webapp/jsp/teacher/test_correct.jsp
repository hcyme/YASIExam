					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<c:if
								...
								<c:forEach var="sco" items="${pager.getDateList() }"
									varStatus="v">
									<c:if test="${sco.ifdone=='0'}">
										...
										<tr>
											<td>${index}</td>
											<td><c:forEach items="${courseList }" var="course">
											...
											<td><a
												href="servlet/ScoreCorrectServlet.do?operation=toCorrect&sc_id=${sco.sc_id}">批改</a></td>
										</tr>
									</c:if>
								</c:forEach>
							</c:if>
