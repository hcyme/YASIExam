			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/teacher/index.jsp">首页</a> <span
						class="crumb-step">&gt;</span><span>修改密码</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="ModifyPasswordServlet?flagId=2&userID=${tea_id }"
						method="post" name="myform" onsubmit="return login_pwd_username()">
							...
							<tbody>
								...
								<tr>
									...
									<td><input class="common-text required" id="oldpassword"
										name="oldpass" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>新密码：</th>
									<td><input class="common-text required" id="newpassword"
										name="newpass" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red">*</i>确认密码：</th>
									<td><input class="common-text required"
										id="confirmpassword" name="repass" size="50" value=""
										type="text"></td>
								</tr>
								<tr>
									<th></th>
