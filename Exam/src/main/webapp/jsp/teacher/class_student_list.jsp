	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="jsp/teacher/index.jsp">首页</a><span
						...
						href="jsp/teacher/class_list.jsp">班级管理</a><span class="crumb-step">&gt;</span><span>查看班级</span>
				</div>
			</div>
			...
			<div class="result-wrap">
				...
				<form
					action="Class_List_BrowseServlet?updateclassform=updateStudentForm&classid=${param.classid}"
					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<c:forEach var="stdBean" items="${studentList}">
								<tr>
									<td class="tc" width="10%"><input class="allChoose"
